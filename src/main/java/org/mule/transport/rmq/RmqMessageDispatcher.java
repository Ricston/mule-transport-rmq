/*
 * $Id: RmqMessageDispatcher.java 1486 2011-09-30 09:57:05Z claude.mamo $
 * --------------------------------------------------------------------------------------
...
public class RmqMessageDispatcher extends AbstractMessageDispatcher
{
    ...
    {
        // Send the message as bytes over the exchange attached with the specified
        // topic (NO REPLY).
        channel.basicPublish(exchange.getName(), topic, null, event.getMessageAsBytes());
    }
