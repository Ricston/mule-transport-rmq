/*
 * $Id: RmqMessagePollingReceiver.java 1486 2011-09-30 09:57:05Z claude.mamo $
 * --------------------------------------------------------------------------------------
...
public class RmqMessagePollingReceiver extends AbstractPollingMessageReceiver
{
    ...
    public RmqMessagePollingReceiver(Connector connector, Service service, InboundEndpoint endpoint)
