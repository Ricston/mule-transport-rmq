/*
 * $Id: MultiFunctionalTestCase.java 1486 2011-09-30 09:57:05Z claude.mamo $
 * --------------------------------------------------------------------------------------
...
public class MultiFunctionalTestCase extends org.mule.tck.FunctionalTestCase
{

    protected String getConfigResources()
    {
        return "src/test/resources/multi-mule-config.xml";
    }
    ...
    public void testSpamMessages() throws Exception
    {
        ...
        MuleClient client = null;
        Map<String, String> messg_list1 = new HashMap<String, String>();
        Map<String, String> messg_list2 = new HashMap<String, String>();
        int limit = 5;
        ...
        try
        {
            ...
            {
                messg_list1.put("This is " + i, "This is " + i);
                messg_list2.put("This is " + i, "This is " + i);
                client.dispatch("vm://inbound", messg_list1.get("This is " + i), null);
            }
            ...
            for (int i = 0; i < limit; i++)
            {
                ...
                assertNotNull(messg_list1.get(reply.getPayloadAsString()));
                assertEquals(messg_list1.get(reply.getPayloadAsString()), reply.getPayloadAsString());
                messg_list1.remove(reply.getPayloadAsString());
            }
            ...
            for (int i = 0; i < limit; i++)
            {
                ...
                assertNotNull(reply);
                assertNotNull(reply.getPayload());
                assertNotNull(messg_list2.get(reply.getPayloadAsString()));
                assertEquals(messg_list2.get(reply.getPayloadAsString()), reply.getPayloadAsString());
                messg_list2.remove(reply.getPayloadAsString());
            }
