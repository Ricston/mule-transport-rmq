/*
 * $Id: RmqConnectorParserTest.java 1486 2011-09-30 09:57:05Z claude.mamo $
 * --------------------------------------------------------------------------------------
...
public class RmqConnectorParserTest extends TestCase
{
    ...
    /*
     * Possible Formats - CONNECTOR URIS host:port/virtualHost host:port
     * username:password@host:port/virtualHost username:password@host:port
     */
