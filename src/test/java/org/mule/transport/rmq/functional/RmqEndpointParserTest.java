/*
 * $Id: RmqEndpointParserTest.java 1486 2011-09-30 09:57:05Z claude.mamo $
 * --------------------------------------------------------------------------------------
...
public class RmqEndpointParserTest extends TestCase
{
    ...
    /*
     * Possible Formats - ENDPOINT URIS schema://exchange:queue/key
     * schema://exchange/key
     */
    ...
    RmqEndpointParser rep7 = new RmqEndpointParser(
        "rmq://exchange:queue{durable, exclusive, autoDelete}/org.com.*");
