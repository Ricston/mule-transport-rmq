/*
 * $Id: NamespaceURIFunctionalTestCase.java 1486 2011-09-30 09:57:05Z claude.mamo $
 * --------------------------------------------------------------------------------------
...
package org.mule.transport.rmq.functional.namespace;
...
public class NamespaceURIFunctionalTestCase extends org.mule.tck.FunctionalTestCase
{

    protected String getConfigResources()
    {
        return "src/test/resources/namespace-uri-mule-config.xml";
    }
